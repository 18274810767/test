	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			...
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th>姓名</th>
					<td><input name="realname" type="text" placeholder="请输入姓名" class="easyui-validatebox span2" data-options="required:true" ></td>
					<th>薪资标准</th>
					<td>
					<select name="solaryTypeId" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							<c:forEach items="${solarytypeList}" var="solaryType">
								<option value="${solaryType.level}">${solaryType.name}</option>
							</c:forEach>
					</select>
					</td>
				</tr>
				<tr>
					...
					<th>身份证号</th>
					<td><input name="cardNum" type="text" placeholder="请输入身份证号" class="easyui-validatebox span2"></td>
				</tr>
				<tr>
					<th>推荐人</th>
					<td><input name="tuijianren" type="text" placeholder="请输入推荐人" class="easyui-validatebox span2"></td>
					<th>职务</th>
					<td><input name="zhiwu" type="text" placeholder="请输入职务" class="easyui-validatebox span2"></td>
				</tr>
				<tr>
					<th>公司代码</th>
					<td><input name="gcode" type="text" placeholder="请输入公司代码" class="easyui-validatebox span2"></td>
					<th></th>
					<td></td>
				</tr>
				<tr>
					<th>住址</th>
					<td colspan="3"><textarea name="adr" rows="" cols="" class="span5"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
