...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/dzongjieController/add',
			onSubmit : function() {
				editor.sync();
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th>工作内容</th>
					<td colspan="3"><textarea name="notes" rows="" cols="" class="span8" placeholder="请输入工作内容" data-options="required:true"></textarea></td>
				</tr>
				<tr>
					<th>已完成工作</th>
					<td colspan="3"><textarea name="finished" rows="" cols="" class="span8" placeholder="请输入完成的工作" data-options="required:true"></textarea></td>
				</tr>
